...
wget -O- https://raw.githubusercontent.com/julenvitoria/FreeplayGBA-SuperRetroBoyTheme/master/STBtheme.sh>/home/pi/RetroPie/retropiemenu/Update-Addons/SRBtheme.sh
